...
"body{font-family:Rajdhani,sans-serif;font-weight:var(--weight-normal);line-height:var(--leading-normal);color:var(--color-text-primary);background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);min-height:100vh;overflow-x:hidden;position:relative}"
...
".logo{width:56px;height:56px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,var(--color-primary),var(--color-accent));border-radius:var(--radius-md);color:#fff;font-size:var(--text-3xl);box-shadow:var(--shadow-md)}"
".company-info h1{margin:0;font-size:var(--text-3xl);font-weight:var(--weight-black);background:linear-gradient(135deg,var(--color-primary),var(--color-accent));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}"
".company-info p{margin:var(--space-xs) 0 0;font-size:var(--text-sm);color:var(--color-text-tertiary);font-family:Orbitron,monospace;letter-spacing:0.1em;text-transform:uppercase}"
"/* ===== CARDS ===== */"
".card,.sensor-card{background:rgba(255,255,255,0.95);border:1px solid rgba(255,255,255,0.4);border-radius:var(--radius-xl);padding:var(--space-xl);margin:var(--space-lg) 0;box-shadow:var(--shadow-lg);position:relative;transition:transform var(--transition-base),box-shadow var(--transition-base);overflow:hidden;min-height:100px;display:flex;flex-direction:column;justify-content:center;will-change:transform;transform:translateZ(0)}"
...
".card p,.sensor-card p{color:var(--color-text-secondary);line-height:var(--leading-relaxed);margin-bottom:var(--space-sm)}"
...
".card-metric{display:flex;flex-direction:column;gap:var(--space-xs)}"
".card-metric-label{font-size:var(--text-xs);color:var(--color-text-tertiary);text-transform:uppercase;letter-spacing:0.05em;font-weight:var(--weight-medium)}"
".card-metric-value{font-size:var(--text-2xl);font-weight:var(--weight-bold);color:var(--color-primary);font-family:Orbitron,monospace}"
"/* ===== LAYOUT ===== */"
...
".menu-icon{width:24px;height:24px;display:flex;align-items:center;justify-content:center;font-size:var(--text-lg);transition:all var(--transition-base)}"
"/* ===== SECTIONS ===== */"
...
"/* ===== SIDEBAR HEADER ===== */"
".sidebar .header{background:rgba(255,255,255,0.98);backdrop-filter:blur(16px);border-bottom:1px solid rgba(255,255,255,0.4);padding:var(--space-2xl) var(--space-xl);margin:0;border-radius:0;box-shadow:0 4px 20px rgba(0,0,0,0.08);position:relative;overflow:hidden}"
".sidebar .header::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;background:linear-gradient(90deg,var(--color-primary) 0%,var(--color-accent) 50%,var(--color-success) 100%);box-shadow:0 2px 8px var(--glow-primary)}"
".sidebar .company-info h1{color:var(--color-primary);font-size:var(--text-2xl);font-family:Orbitron,monospace;font-weight:var(--weight-black);z-index:2;position:relative;margin-bottom:var(--space-xs)}"
".sidebar .company-info p{color:var(--color-text-tertiary);font-size:var(--text-xs);letter-spacing:0.1em;text-transform:uppercase;font-family:Orbitron,monospace;font-weight:var(--weight-medium);z-index:2;position:relative}"
"/* ===== STATUS INDICATORS ===== */"
...
":root{--space-xs:3px;--space-sm:6px;--space-md:12px;--space-lg:16px;--space-xl:20px;--space-2xl:24px;--space-3xl:32px}"
".container{display:block}"
".sidebar{width:100%;height:auto;position:static;overflow:visible;border-right:none;border-bottom:1px solid rgba(255,255,255,0.3)}"
".main-content{margin-left:0;padding:var(--space-md)}"
".menu-item{padding:var(--space-sm) var(--space-md);font-size:var(--text-xs);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}"
".section{padding:var(--space-md);margin-bottom:var(--space-md);border-radius:var(--radius-md)}"
".section-title{font-size:var(--text-lg);margin-bottom:var(--space-md);padding-bottom:var(--space-sm)}"
".section-title i{width:32px;height:32px;font-size:var(--text-base)}"
".card,.sensor-card{padding:var(--space-md);margin:var(--space-sm) 0;border-radius:var(--radius-md);text-align:center}"
".card h3,.sensor-card h3{font-size:var(--text-base);margin-bottom:var(--space-sm);text-align:center;color:var(--primary-700);font-weight:var(--weight-bold)}"
".card p,.sensor-card p{font-size:var(--text-sm);line-height:1.4;text-align:center;color:var(--color-text-primary)}"
".card strong,.sensor-card strong{display:block;text-align:center;color:var(--primary-800);font-size:var(--text-sm);margin:var(--space-xs) 0}"
".card-header{text-align:center;justify-content:center}"
".card *,.sensor-card *{position:relative;z-index:2}"
".card label,.sensor-card label{display:block;text-align:center;color:var(--primary-800);font-weight:var(--weight-semibold);margin-bottom:var(--space-xs)}"
"input,select,textarea{width:100%;padding:var(--space-sm);font-size:16px;border-radius:var(--radius-sm)}"
"button,.btn{padding:var(--space-sm) var(--space-md);width:100%;font-size:var(--text-xs);min-height:44px;white-space:nowrap}"
"table{font-size:var(--text-xs);overflow-x:auto;display:block}"
"th,td{padding:var(--space-xs) var(--space-sm);font-size:var(--text-xs)}"
".header{flex-direction:column;text-align:center;align-items:center;padding:var(--space-md)}"
".logo{width:40px;height:40px;font-size:var(--text-xl);margin-bottom:var(--space-sm)}"
".company-info{width:100%;text-align:center}"
".company-info h1{font-size:var(--text-lg);margin:0}"
".company-info p{font-size:10px;margin-top:var(--space-xs)}"
".badge{font-size:10px;padding:2px var(--space-xs)}"
".badge::before{width:4px;height:4px}"
".card-metric-label{font-size:10px}"
".card-metric-value{font-size:var(--text-lg)}"
".grid-2,.grid-3,.grid-4{grid-template-columns:1fr;gap:var(--space-sm)}"
".flex-between{flex-direction:column;align-items:stretch;gap:var(--space-sm)}"
"h1{font-size:var(--text-2xl);line-height:1.2}h2{font-size:var(--text-xl);line-height:1.2}h3{font-size:var(--text-lg);line-height:1.3}"
"p{font-size:var(--text-sm);line-height:1.5}"
".test-result,.alert{padding:var(--space-md);margin:var(--space-sm) 0}"
".sidebar .header{padding:var(--space-md)}"
".sidebar .company-info h1{font-size:var(--text-base)}"
"}"
"@media (min-width:481px) and (max-width:768px){"
".container{display:block}"
".sidebar{width:100%;height:auto;position:static;overflow:visible;border-right:none;border-bottom:1px solid rgba(255,255,255,0.3)}"
".main-content{margin-left:0;padding:var(--space-lg)}"
".menu-item{padding:var(--space-md) var(--space-lg);font-size:var(--text-sm)}"
".section{padding:var(--space-lg);margin-bottom:var(--space-lg)}"
".section-title{font-size:var(--text-2xl)}"
".card,.sensor-card{padding:var(--space-lg);margin:var(--space-md) 0}"
"input,select,textarea{width:100%;font-size:16px}"
"button,.btn{padding:var(--space-md) var(--space-lg);width:100%;font-size:var(--text-sm);min-height:48px}"
"table{font-size:var(--text-sm);overflow-x:auto;display:block}"
".header{flex-direction:column;text-align:center;padding:var(--space-lg)}"
".logo{margin-bottom:var(--space-md)}"
".company-info h1{font-size:var(--text-xl)}"
".company-info p{font-size:var(--text-xs)}"
