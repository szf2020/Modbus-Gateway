...
".header{flex-direction:row;text-align:left;align-items:center;padding:var(--space-md);gap:var(--space-sm)}"
".header{justify-content:center;padding:var(--space-sm)}"
".logo{height:32px;max-width:90%;width:auto}"
".badge{font-size:10px;padding:2px var(--space-xs)}"
".badge::before{width:4px;height:4px}"
".card-metric{gap:4px;padding:var(--space-sm)}"
".card-metric-label{font-size:10px;line-height:1.2}"
".card-metric-value{font-size:var(--text-lg);line-height:1}"
".status-item{padding:var(--space-sm);gap:4px}"
".status-item strong{font-size:11px;margin-bottom:4px}"
".status-item span{font-size:var(--text-sm)}"
...
".sidebar .header{padding:var(--space-sm)}"
".sidebar .logo{height:30px}"
".wifi-grid{grid-template-columns:1fr;gap:var(--space-sm)}"
".wifi-grid label{font-size:var(--text-sm);margin-bottom:4px}"
".menu-item{font-size:var(--text-xs);padding:var(--space-sm) var(--space-md)}"
".menu-icon{width:20px;height:20px;min-width:20px;font-size:var(--text-base)}"
"}"
...
static esp_err_t config_page_handler(httpd_req_t *req)
{
    ...
    snprintf(chunk, sizeof(chunk),
        ...
        "<h3 style='text-align:center'>Offline Message Caching</h3>"
        "<p style='color:#666;margin-bottom:15px;text-align:center'>Enable offline message caching during network outages</p>"
        "<label style='display:inline-block;cursor:pointer;padding:10px;background:#f8f9fa;border-radius:6px;text-align:left'>"
        ...
        "</label><br><br>"
        "<div id='sd_options' style='display:%s;text-align:left'>"
        "<label style='display:inline-block;cursor:pointer;padding:8px;background:#e8f4f8;border-radius:6px;margin-bottom:15px;text-align:left'>"
    ...
    snprintf(chunk, sizeof(chunk),
        ...
        "<div class='sensor-card' style='text-align:left'>"
        "<h3 style='text-align:center'>Accurate Timekeeping</h3>"
        "<p style='color:#666;margin-bottom:15px;text-align:center'>Maintain accurate time even during network outages</p>"
        "<label style='display:inline-block;cursor:pointer;padding:10px;background:#f8f9fa;border-radius:6px;text-align:left'>"
        ...
        "</label><br><br>"
        "<div id='rtc_options' style='display:%s;text-align:left'>"
        "<label style='display:inline-block;cursor:pointer;padding:8px;background:#e8f4f8;border-radius:6px;margin-bottom:10px;text-align:left'>"
